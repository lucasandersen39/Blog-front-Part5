      ...
      <form onSubmit={addBlog} className="blogForm">
        <div className="blogForm__input">
          ...
          <input type="text" value={title}
            onChange={({ target }) => setTitle(target.value)} name="title" id="title" data-testid="title-input" />
        </div>
        <div className="blogForm__input">
          <label htmlFor="author">Author</label>
          <input type="text" value={author}
            onChange={({ target }) => setAuthor(target.value)} name="author" id="author" data-testid="author-input" />
        </div>
        <div className="blogForm__input">
